...
var (
	cycleCmd = &cobra.Command{
		Use:   "cycle <[0,30]>",
		Short: "Cycle reads or sets value of the Cycle mode",
		Long: `Cycle reads or sets value of the Cycle mode
		...
		1 - 30 - for one measurement per <N> minutes, where <N> is chosen value
